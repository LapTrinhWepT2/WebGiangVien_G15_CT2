	 		...
	 		<div class="row">
	 			<div class="col-md-8 col-md-offset-0">
				  <div class="container">
					  ...
					  <a class = "btn btn-default" HREF="GV_ThemLopHoc.jsp" role="button">Thêm Lớp học</a>
					  <div class="panel-group">
					    <div class="panel panel-default">
					      <div class="panel-heading">Lớp</div>
					      <div class="panel-body">
					      	<li>
					      		<a href="GV_LopBoMon.jsp">Công nghệ phần mềm_01</a>
					      	</li>
					      	<li>
								    ...
								    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
								      <div class="panel-body">
								        	<ul class="ulChildrent tabHTML_Content">
							                    ...
							                    <li>
							                       <a href="#" target="_blank">Slide_2Power point)</a>
							                    </li>
							                    <li>
