	...
	<div id="content">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6">
					<h2>Cập nhật/Chỉnh sửa chức vụ</h2>
					<form>
						<div class="form-group">
							<label for="tt_chucvu">Chức vụ:</label>
							<textarea name="ChucVu" id="tt_chucvu" cols="30" rows="10" placeholder="Chức vụ" class= "form-control"></textarea>
						</div>
					</form>
					<div class="button"> 
