	...
	<div id="content">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6">
					<h2>Cập nhật Danh hiệu/Giải thưởng</h2>
					<form>
						<div class="form-group">
							<label for="tt_danhhieu">Danh hiệu/Giải thưởng:</label>
							<textarea name="DanhHieu" id="tt_danhhieu" cols="30" rows="10" placeholder="Danh hiệu/Giải thưởng" class= "form-control"></textarea>
						</div>
					</form>
					<div class="button"> 
