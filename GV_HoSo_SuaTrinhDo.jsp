	...
	<div id="content">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6">
					<h2>Chỉnh sửa trình độ cá nhân</h2>
					<form>
						<div class="form-group">
							<label for="tt_trinhdo">Trình độ:</label>
							<textarea name="TrinhDo" id="tt_trinhdo" cols="30" rows="10" placeholder="Nhập trình độ" class= "form-control"></textarea>
						</div>
					</form>
					<div class="button"> 
