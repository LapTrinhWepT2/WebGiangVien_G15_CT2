		...
		<div class="container">
			<div class="row">
				<form action="#" method="post" class="form-horizontal" id="commentForm" name="form" ng-submit="comment()" novalidate  >
				    <div class="form-group">
				        <label for="name" class="col-sm-2 control-label">Tên bài tập:</label>
				        <div class="col-sm-10">
				            <input type="text" class="form-control" name="name" id="name">
				        </div>
				    </div>
				    <div class="form-group">
				        <label for="ndung" class="col-sm-2 control-label">Nội dung</label>
				        <div class="col-sm-10">
				            <input type="text" class="form-control" name="ndung" id="ndung">
				    ...
				    <div class="form-group">
				        ...
				        <div class="col-sm-10">
				            <input type="datetime-local" name="deadline" /><span class="glyphicon glyphicon-calendar"></span>
				        </div>
				    </div>
				    <div class="form-group">
				        <button class="btn btn-primary" style="margin-left:215px">Lưu</button>
				    </div>
				</form>
			</div><!-- /row -->
		</div><!-- /container -->
