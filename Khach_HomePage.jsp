			...
			<div class="container">
				...
				<ul class="nav navbar-nav navbar-right">
					<li class= "navbar-right">
						<a href="DangNhap.jsp" class="topnav-icons navbar-right"><span>Đăng nhập</span></a>
					</li>	
					<li class= "navbar-right">
			...
			<div id="myCarousel" class="carousel slide" data-ride="carousel">
			    ...
			    <div class="carousel-inner" role="listbox">
			        <div class="item active">
			            <a href="Khach_HoSo.jsp"><img src="Image/1.jpg" alt="Chania"></a>
			        </div>

			        <div class="item">
			            <a href="Khach_HoSo.jsp"><img src="Image/2.jpg" alt="Chania" ></a>
			        </div>

			        <div class="item">
			           <a href="Khach_HoSo.jsp"> <img src="Image/3.png" alt="Flower"></a>
			        </div>

			        <div class="item">
			            <a href="Khach_HoSo.jsp"><img src="Image/4.jpg" alt="Flower" ></a>
			        </div>
			    </div>
		...
		<div class="site-footer">
			<div class="container">
				...
				<div class="bottom-footer">
					...
					<div class="col-md-7">
						<ul class="footer-nav">
							<li><a href="Khach_HomePage.jsp">Trang Chủ</a></li>
							<li><a href="Khach_HoSo.jsp">Hồ sơ</a></li>
							<li><a href="Khach_NghienCuu.jsp">Nghiên cứu</a></li>
							<li><a href="Khach_AnPham.jsp">Ấn phẩm</a></li>
							<li><a href="Khach_KhoaHoc.jsp">Khóa học</a></li>
							<li><a href="Khach_ThaoLuan.jsp">Thảo luận</a></li>
						</ul>
					</div>
				</div>
			</div>
