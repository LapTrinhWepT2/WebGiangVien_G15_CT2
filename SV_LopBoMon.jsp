			...
			<div class="container">
				...
				<ul class="nav navbar-nav navbar-right">
					<li class= "navbar-right dropdown">
						<a href="DangNhap.jsp" class="navbar-right dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span><span>Sinh Vien</span><span class="caret"></span></a>
	 			...
	 			<div class="col-md-8 col-md-offset-0">
				  	<div class="container">
					    ...
					    <div class="panel panel-primary">
					     	...
					     	<div class="panel-body">
					      		<a href="SV_KeHoachHocTap.jsp" >Chi tiết Kế hoạch học tập</a>
					      	</div>
					    </div>
					    ...
					    <div class="panel panel-success">
					      	...
					      	<div class="panel-body">
					      		<a href="SV_DSSV.jsp">Danh sách</a>
					      	</div>
					    </div>
					    ...
					    <div class="panel panel-info">
					      	...
					      	<div class="panel-body">
					      		<li ><A HREF="SV_BaiTap.jsp" >Bài tập 1</A></li>
